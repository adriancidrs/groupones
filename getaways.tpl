...
<div id="container">
    ...
    <form action="/respuestagetaways" method="POST">
      <br/><p>Enter your favorite country. Example, Thailand, Spain, France...</p><br/>
      <select name="country">
	...
	<option value="Bosnia and Herzegowin">Bosnia and Herzegowina</option>
	...
	<option value="Gabon">Gambia</option>
	...
	<option value="LLithuaniaT">Lithuania</option>
